...
var ArgumentDictionaryProvider = /** @class */ (function () {
    function ArgumentDictionaryProvider(helpCommand, initCommand, createContractModelCommand, createServiceCommand, createScriptCommand, writeContractsCommand, compileContractsCommand, deployContractsCommand) {
        ...
        // DICTIONARY
        this.aliasesDictionary = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, this.registryAlias({
            baseArg: "help",
            aliases: ["-h", "--help"],
        })), this.registryAlias({
            baseArg: "init",
    ...
    ArgumentDictionaryProvider = __decorate([
        ...
        __param(4, (0, tsyringe_1.inject)("CreateScriptCommand")),
        __param(5, (0, tsyringe_1.inject)("WriteContractsCommand")),
        __param(6, (0, tsyringe_1.inject)("CompileContractsCommand")),
        __param(7, (0, tsyringe_1.inject)("DeployContractsCommand")),
