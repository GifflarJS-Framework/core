...
var CompileContracts = /** @class */ (function () {
    ...
    CompileContracts.prototype.execute = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            var configFile, files, compile;
            return __generator(this, function (_a) {
                configFile = JSON.parse((0, files_1.readFile)({
                ...
                compile = function (_a) {
                    ...
                    if ((0, files_1.fileExists)({
                        path: path_1.default.resolve(configFile.compileFolder, "".concat(gContract.name, "_dump.json")),
                    })) {
                    ...
                    if (!(0, files_1.fileExists)({
                        ...
                        (0, files_1.writeFile)({
                            destPath: path_1.default.resolve(configFile.contractsFolder, "".concat(gContract.name, ".sol")),
                    ...
                    // Saving ABI
                    (0, files_1.writeFile)({
                        destPath: path_1.default.resolve(configFile.compileFolder, "".concat(gContract.name, ".json")),
                        content: JSON.stringify(json.contracts.jsons[gContract.name].abi, null, 2),
                    });
                    // Saving Metadata
                    (0, files_1.writeFile)({
                        destPath: path_1.default.resolve(configFile.compileFolder, "".concat(gContract.name, "_metadata.json")),
                        content: JSON.stringify(JSON.parse(json.contracts.jsons[gContract.name].metadata), null, 2),
                    });
                    // Saving dump file
                    (0, files_1.writeFile)({
                        destPath: path_1.default.resolve(configFile.compileFolder, "".concat(gContract.name, "_dump.json")),
