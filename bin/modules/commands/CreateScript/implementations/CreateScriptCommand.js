...
var CreateScriptCommand = /** @class */ (function () {
    ...
    CreateScriptCommand.prototype.execute = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            var content, configFile, npmCommand, yarnCommand, scriptFiles, scriptOrder;
            return __generator(this, function (_a) {
                ...
                if (!(0, files_1.fileExists)({
                    path: path_1.default.resolve(process.cwd(), "node_modules", "types-gifflar/modules/commands/DeployContracts/dtos/IScriptFunctionInputs.d.ts"),
                })) {
                    npmCommand = "npm install -dev git+https://github.com/GifflarJS-Framework/types-gifflar.git";
                    yarnCommand = "yarn add -D git+https://github.com/GifflarJS-Framework/types-gifflar.git";
                    throw new Error("You must install types-gifflar first. Please, run \"".concat(npmCommand, "\" or \"").concat(yarnCommand, "\""));
                }
                ...
                if (configFile.scriptsFolder !== "./") {
                    (0, files_1.makeDirectory)({ path: "".concat(process.cwd(), "/").concat(configFile.scriptsFolder) });
                }
                ...
                // Creating script
                (0, files_1.copyFile)({
                    sourcePath: path_1.default.resolve(__dirname, "../templates/MakeScriptTemplate.template"),
                    destPath: path_1.default.resolve(process.cwd(), configFile.scriptsFolder, "".concat(scriptOrder, "_").concat(value, ".ts")),
                });
                return [2 /*return*/];
            });
        });
