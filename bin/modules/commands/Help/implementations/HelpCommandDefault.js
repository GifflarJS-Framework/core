...
var HelpCommandDefault = /** @class */ (function () {
    function HelpCommandDefault() {
    }
    HelpCommandDefault.prototype.execute = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log(" init, --init                               \t Initializes the Gifflar configuration file.");
                console.log(" make");
    ...
    return HelpCommandDefault;
}());
exports.default = HelpCommandDefault;
