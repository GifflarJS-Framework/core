...
| <div style="width:140px">make:model <br/> --make:model <br/> -m:model</div>   | Model file name.                                                                                 | Yes            | Make a new Gifflar Contract Model.                                                                             |
| <div style="width:140px">make:service<br/>--make:service<br/>-m:service</div> | Service file name.                                                                               | Yes            | Make a new Gifflar Contract Service.                                                                           |
| <div style="width:140px">make:script<br/>--make:script<br/>-m:script</div>    | Script file name.                                                                                | Yes            | Make a new Gifflar Deploying Script.                                                                           |
