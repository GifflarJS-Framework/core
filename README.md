...
| <div style="width:140px">Command</div>         | Args                                                                                             | Mandatory args | Description                                                                                                    |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------- | -------------------------------------------------------------------------------------------------------------- |
...
| make:model<br/>--make:model<br/>-m:model       | Model file name.                                                                                 | Yes            | Make a new Gifflar Contract Model.                                                                             |
| make:service<br/>--make:service<br/>-m:service | Service file name.                                                                               | Yes            | Make a new Gifflar Contract Service.                                                                           |
| make:script<br/>--make:script<br/>-m:script    | Script file name.                                                                                | Yes            | Make a new Gifflar Deploying Script.                                                                           |
